...
export function CourierRow({ courier }: CourierRowProps) {
  ...
  return (
    <tr className="border-b border-[#2D2A26]/10 dark:border-[#E8E6E3]/10 last:border-0 hover:bg-[#E8E6E3]/50 dark:hover:bg-[#3D3A36]/50 transition-colors">
      <td className="p-4">
        <Link
